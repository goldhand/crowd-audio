...
.. code-block:: bash
    ...
    heroku run python crowd-audio/manage.py syncdb --noinput --settings=config.settings
    heroku run python crowd-audio/manage.py migrate --settings=config.settings
    heroku run python crowd-audio/manage.py collectstatic --settings=config.settings
